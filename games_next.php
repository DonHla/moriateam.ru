...
if ($_COOKIE['position'] == 3) //значит игрок
{
echo '*Если здесь нет списка команд, то значит вы не записались на будущую игру.';
}
else if ($_COOKIE['position'] == 5) //значит мастер
{
echo '*Если здесь нет списка команд, то значит вы не назначили игр в будущем или никто пока не записался в команду.';
}
else echo 'Ошибка!';
?>
